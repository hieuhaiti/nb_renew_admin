  ...
  return (
    <main className="bg-background grid min-h-screen place-items-center px-6 py-24 transition-colors duration-400 sm:py-32 lg:px-8">
      <div className="text-center">
        <p className="text-4xl text-(--error-404-bg-color)">404</p>
        ...
        <div className="mt-10 flex items-center justify-center">
          <button
            onClick={() => navigate('/')}
            className="rounded-md bg-(--error-404-bg-color) px-4 py-2 text-sm text-white shadow-(--shadow-md) transition hover:brightness-90"
          >
            {'Quay lại trang chủ'}
          </button>
        </div>
